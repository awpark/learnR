...
This is the third in a series of exercises that constitute _Training Module 1: Introduction to Scientific Programming_, taught through the IDEAS PhD program at the University of Georgia Odum School of Ecology in conjunction with the Center for the Ecology of Infectious Diseases. 

If coding in R is relatively new to you, you may find it helpful to first watch this introductory video that introduces ideas we'll be using
