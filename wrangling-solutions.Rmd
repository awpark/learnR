...
## Combining dataframes using join functions
...
*Task 14: Use `inner_join` to create a new dataframe called 'ld.pop' which joins the 'ld' and 'pop' dataframes you created.*
