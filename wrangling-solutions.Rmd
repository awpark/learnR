...
4. Complete and solve coding challenges related to data wrangling
...
library(magrittr)
pop <- read_csv("https://raw.githubusercontent.com/awpark/learnR/master/pop.csv")
pop.GA <- read_csv("https://raw.githubusercontent.com/awpark/learnR/master/popGA.csv")
pop2 <- read_csv("https://raw.githubusercontent.com/awpark/learnR/master/pop2.csv")
```
...
#get map data for US counties and states (part of ggplot)
