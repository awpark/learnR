...
*Task 5: Use `gather`, `str_replace_all`, and `as.integer` to change cells in the year column from, for example, the character "pop2001" to the integer "2001".*
...
library(tidyverse)
library(magrittr)
pop <- read_csv("https://raw.githubusercontent.com/awpark/learnR/master/ld7-8.csv")
```
